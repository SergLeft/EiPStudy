...
org = pygame.image.load('Vorlesung13/_images/Pacman.png')
pacman = pygame.transform.scale(org,(40,40))
org = pygame.image.load('Vorlesung13/_images/Inky.png')
inky = pygame.transform.scale(org,(40,40))
org = pygame.image.load('Vorlesung13/_images/Blinky.png')
blinky = pygame.transform.scale(org,(40,40))
org = pygame.image.load('Vorlesung13/_images/Clyde.png')
clyde = pygame.transform.scale(org,(40,40))
org = pygame.image.load('Vorlesung13/_images/Pinky.png')
