...
org = pygame.image.load('Vorlesung13/_images/Muehle.png')
...
BMorg = pygame.image.load('Vorlesung13/_images/BlackMan.png')
WMorg = pygame.image.load('Vorlesung13/_images/WhiteMan.png')
radMan = minWH/10
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.MOUSEBUTTONDOWN:
            ...
            if movingPhase:
                ...
                if removeMan:
                    print('remove')
                    if b in men[(turn+1)%2]:
                        men[(turn+1)%2].remove(b)
                    else:
                        break
                    removeMan = False
                else:
